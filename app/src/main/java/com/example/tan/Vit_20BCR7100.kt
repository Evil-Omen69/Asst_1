    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Column(
                ...
                Text(text = "Create your Google Account", fontSize = 30.sp, color = Color.Black, fontWeight = FontWeight.ExtraBold, fontFamily = FontFamily.Serif, modifier = Modifier
                ...
                Text(text = "You can use letters, numbers & periods", fontSize = 10.sp,modifier = Modifier.align(Alignment.CenterHorizontally))
                ...
                Spacer(modifier = Modifier.height(5.dp))
                Text(text = "Use 8 or more characters with a mix of letters, numbers & symbols", fontSize = 10.sp, modifier = Modifier.align(Alignment.CenterHorizontally))
                Spacer(modifier = Modifier.height(20.dp))
                tickbox()
                Column(
